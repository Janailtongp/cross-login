...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Cross Login | @janailtongp</title>
        ...
        <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
            ...
            <div class="row">
                <div class="title m-b-md">
                    <p class="typewriter">Work in Progress</p>
                    <p class="sub">QR code cross login from mobile app. Laravel + React Native</p>
                    <p class="sub2">Download APK: coming soon ...</p>
                </div>
            </div>
        </div>
    </body>
